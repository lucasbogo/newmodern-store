                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="waves-effect waves-light rounded dropdown-toggle p-0"
                            ...
                            <img src="<?php echo e(!empty($editData->profile_photo_path)
                        ...
                        <ul class="dropdown-menu animated flipInX">
                            <li class="user-body">
                                ...
                                <!-- LINK MUDAR SENHA -->     
                                <a class="dropdown-item" href="<?php echo e(route('admin.change.password')); ?>"><i class="ti-wallet text-muted mr-2"></i>
                                    Change Password</a>
...
<?php /**PATH /home/lucas/newmodern-store/resources/views/admin/body/header.blade.php ENDPATH**/ ?>