                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table class="table no-border">
                                        ...
                                        <tbody>
                                            <tr>
                                                <!-- Mudar imagem do produto - **ARTE photoshop/illustrator** -->
                                                <td class="pl-0 py-8">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 mr-20">
                                                            <div class="bg-img h-50 w-50"
                                                                style="background-image: url(<?php echo e(asset('backend/images/gallery/creative/img-1.jpg')); ?>)">
                                                            </div>
                                                        </div>
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lucas/newmodern-store/resources/views/admin/index.blade.php ENDPATH**/ ?>