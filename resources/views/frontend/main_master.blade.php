                ...
                <ul class="dropdown-menu mega-menu">
                  <li class="yamm-content">
                    <div class="row">
                      ...
                      <div class="dropdown-banner-holder"> <a href="#"><img alt="" src="{{ asset('') }}rontend/assets/images/banners/banner-side.png" /></a> </div>
                    </div>
                    <!-- /.row --> 
                  </li>
                  <!-- /.yamm-content -->
        ...
        <div class="sidebar-widget hot-deals wow fadeInUp outer-bottom-xs">
          ...
          <div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-ss">
            ...
            <div class="item">
              <div class="products">
                <div class="hot-deal-wrapper">
                  <div class="image"> <img src="frontend/sassets/images/hot-deals/p10.jpg" alt=""> </div>
                  <div class="sale-offer-tag"><span>35%<br>
                    off</span></div>
                  <div class="timing-wrapper">
                    <div class="box-wrapper">
...
<script type="{{ asset('frontend/text/javascrip') }}t" src="{{ ('frontend/assets/js/lightbox.min.js') }}"></script> 
